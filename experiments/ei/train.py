"""EI training entry point with composed configs and train/test banks."""
...
from LLM4RL.experiments.runner import SUPPORTED_ALGORITHMS, run_baseline  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run EI formal training")
    ...
    parser.add_argument("--train-bank")
    parser.add_argument("--test-bank")
    parser.add_argument("--seeds", default="42")
    parser.add_argument("--episodes", type=int)
    parser.add_argument("--steps", type=int)
    parser.add_argument("--output-root", default="artifacts/ei/runs")
    return parser
...
def main() -> int:
    ...
    if args.episodes is not None:
        ...
        config.setdefault(args.algorithm, {})["max_episodes"] = args.episodes
    if args.steps is not None:
        config.setdefault("training", {})["max_steps_per_episode"] = args.steps
        config.setdefault(args.algorithm, {})["max_steps"] = args.steps
    results = []
